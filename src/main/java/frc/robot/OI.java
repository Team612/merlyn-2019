...
import frc.robot.commands.Autonomous.StrafeLeft;
import frc.robot.commands.Autonomous.StrafeRight;
...
public class OI 
{
    ...
    public OI(){
        ...
        driver_button_LB.whileHeld(new StrafeLeft());
        driver_button_RB.whileHeld(new StrafeRight());
