...
public class DefaultDrive extends Command {
    ...
    protected void getInput() {
        ...
        direction_y = Robot.m_oi.driver.getX(GenericHID.Hand.kLeft) ;
        direction_x = Robot.m_oi.driver.getY(GenericHID.Hand.kLeft) *-1;
        rotation    = Robot.m_oi.driver.getX(GenericHID.Hand.kRight);
    ...
    protected void execute() {
        ...
        doDead();
        toPolar();
        frc.robot.Robot.drivetrain.getDriveTrain().drivePolar(magnitude, angle, rotation);
